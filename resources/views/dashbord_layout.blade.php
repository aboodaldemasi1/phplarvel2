...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dashpordfiles/css/font-awesome.min.css') }}">
<link rel="stylesheet" href="{{ asset('dashpordfiles/css/bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ asset('dashpordfiles/css/bootstrap-theme.min.css') }}">
<link rel="stylesheet" href="{{ asset('dashpordfiles/css/main.min.css') }}">
<script src="{{ asset('dashpordfiles/js/modernizr-2.8.3.js') }}"></script>
<script src="{{ asset('dashpordfiles/js/jquery-3.1.1.min.js') }}"></script>
...
<body>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 clearfix">
                ...
                القائمة الرئيسية
                            ...
                            <a href="{{route('addCategoryUi')}}" class="list-group-item">اضافة فئة</a>
    ...
    <script src="{{asset('dashpordfiles/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('dashpordfiles/js/app.js')}}"></script>
</body>
